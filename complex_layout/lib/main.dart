...
// NEXT TUTORIAL - ADD INTERACTIVITY -> https://flutter.dev/docs/development/ui/interactive
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: ListView( // use instead of column (allows scrolling on smaller devices)
          children: [
            imageSection,
            titleSection,
            buttonSection,
